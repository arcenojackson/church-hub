...
class _SocietyDetailsPageState extends State<SocietyDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<SocietyModel?>(
      ...
      builder: (context, snap) {
        ...
        return _buildScaffold(context, society, isAdmin: isAdmin);
      },
    );
  }

  Widget _buildScaffold(BuildContext context, SocietyModel society, {required bool isAdmin}) {
          ...
          : ListView(
              ...
              children: [
                ...
                _SectionHeader(
                  ...
                  onAdd: isAdmin
                      ? () => _showAddSheet(context, society, isLeader: true)
                      : null,
                ),
                ...
                if (society.leadersIds.isEmpty)
                  ...
                  ...society.leadersIds.map((id) {
                    ...
                    return _SwipeToRemoveTile(
                      ...
                      name: user?.name ?? id,
                      badge: const Icon(Icons.star_rounded,
                          size: 14, color: Colors.amber),
                      canRemove: isAdmin,
                      onRemove: () => context
                          .read<SocietiesRepository>()
                ...
                _SectionHeader(
                  ...
                  onAdd: isAdmin
                      ? () => _showAddSheet(context, society, isLeader: false)
                      : null,
                ),
                const SizedBox(height: 8),
  ...
  void _showAddSheet(BuildContext context, SocietyModel society,
